...
export default function TrainersPage() {
  ...
  <div className="lg:w-0 lg:flex-1">
    <h2 className="text-3xl font-bold tracking-tight text-white sm:text-4xl">Share Your Passion & Expertise</h2>
    <p className="max-w-3xl text-lg text-green-100 mt-4">Join our growing community of professional trainers across Sri Lanka. Get discovered by athletes, manage your bookings, and build your coaching career with SportsBookSL.</p>
    ...
    <div className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-4">
      <div className="flex items-start">
        ...
        <div className="ml-3">
          <h3 className="text-sm font-medium text-white">Set Your Own Rates</h3>
          <p className="mt-1 text-sm text-emerald-100/80">Full control over your pricing and availability.</p>
        </div>
      </div>
      ...
      <div className="flex items-start">
        ...
        <div className="ml-3">
          <h3 className="text-sm font-medium text-white">Build Your Profile</h3>
          <p className="mt-1 text-sm text-emerald-100/80">Showcase your skills and certifications.</p>
        </div>
      </div>
      ...
      <div className="flex items-start">
        ...
        <div className="ml-3">
          <h3 className="text-sm font-medium text-white">Manage Bookings</h3>
          <p className="mt-1 text-sm text-emerald-100/80">Get notified of new sessions automatically.</p>
        </div>
      </div>
      ...
      <div className="flex items-start">
        ...
        <div className="ml-3">
          <h3 className="text-sm font-medium text-white">Receive Reviews</h3>
          <p className="mt-1 text-sm text-emerald-100/80">Build your reputation with client testimonials.</p>
        </div>
      </div>
    </div>
  </div>
  ...
  <div className="mt-10 lg:mt-0 lg:ml-8 lg:flex-shrink-0 lg:flex lg:flex-col lg:justify-center">
    <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
      ...
      <a href="/trainers" className="inline-flex items-center justify-center rounded-lg border border-white bg-transparent px-5 py-3 text-base font-medium text-white hover:bg-white/10 focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-emerald-600 transition-all duration-300">
        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <p className="text-center mt-4 text-sm text-white/70">
      Simple application process. Get approved in 24-48 hours.
    </p>
  </div>
</div>
</div>
